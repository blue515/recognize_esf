...
main (int argc, char** argv)
{
	...
	std::string model_dir = "/home/blue/recognize_esf/training_data/jar";
	std::string inputname = "/home/blue/recognize_esf/training_data/jar/jar1.pcd";
	...
	// Check if the query object has VFH signature, if not estimate signature and save it in a file
  	if (!checkesf(inputname))
  	{
      pcl::PointCloud <pcl::ESFSignature640> signature;
      estimate_esf(str, signature);
